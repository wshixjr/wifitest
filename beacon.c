...
int32 main()
{
    ...
    init_ap(&t_ap1,(uint8*)"\xEC\x17\x2F\x2D\xB6\xB8","MyFakeAp 1");
    init_ap(&t_ap2,(uint8*)"\xEC\x17\x2F\x2D\xB6\xB9","MyFakeAp 2");
    uint8 t_buffer[1024];
    int32 t_socket=create_raw_socket("wlx60ee5c0b86ad"); //wlan0
    while(1)
    {
